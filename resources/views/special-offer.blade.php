...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/style-player.css">
    <meta charset="UTF-8" />
    ...
    <style type="text/css" class="tve_custom_style">
        @media (min-width: 300px) {
            ...
            [data-css="tve-u-169a7250c95"] .tcb-button-link {
            ...
            #tve_editor [data-css="tve-u-169a7250c95"]:hover .tcb-button-link {
                box-shadow: rgba(0, 8, 4, 0.35) 0px 9px 5px 0px !important;
                background-color: rgb(21, 162, 23) !important;
            }

            [data-css="tve-u-169a7250c95"] {
                display: block;
                max-width: 54%;
                width: 54%;
            ...
            #tve_editor [data-css="tve-u-169a7250c95"] .tcb-button-link {
                line-height: 1.2em;
                font-size: 24px;
            }

            #tve_editor [data-css="tve-u-169a7611ef9"] {
                color: rgb(0, 0, 0) !important;
            }

            [data-css="tve-u-169a762267c"] {
                float: none;
                max-width: 745px;
                margin-left: auto !important;
                margin-right: auto !important;
            ...
            [data-css="tve-u-169aa4ece97"] {
                margin-top: 203px !important;
            }

            #tve_editor [data-css="tve-u-169aa4f0dd1"] {
                font-size: 14px !important;
                color: rgb(51, 51, 51) !important;
            }

            [data-css="tve-u-169aa4f0dd1"] {
                line-height: 1.7em !important;
            }

            [data-css="tve-u-169acb45fdf"] {
                max-width: 869px;
                float: none;
                margin-left: auto !important;
                margin-right: auto !important;
            ...
            [data-css="tve-u-169acb48cdc"] {
                float: none;
                margin: 0px auto 6px !important;
                max-width: 808px !important;
            }

            [data-css="tve-u-169acb7465e"] {
        ...
        @media (max-width: 767px) {
            ...
            #tve_editor [data-css="tve-u-169acb7465e"] {
        ...
        <div class="tve_post_lp tve_lp_blank_v2 tve_lp_template_wrapper" style="">
            <div id="tve_flt" class="tve_flt">
                <div id="tve_editor" class="tve_shortcode_editor">
                    <div class="thrv_wrapper thrv_heading" data-tag="h1" data-css="tve-u-169a722fb4e">
                        <h1 data-css="tve-u-169a7611ef9" style="text-align: center;"><strong>Congratulations! You
                                Qualified for Another Gift!</strong></h1>
                    </div>
                    <div class="thrv_wrapper thrv_text_element" data-css="tve-u-169a762267c">
                        <p style="text-align: center;">A FREE Membership to DiamondBabesHD.com, which contains thousands of DVDs and some of the hottest pornstars in the world! Watch preview below and click green button to access your purchase.</p>
                    </div>
                     <div class="container">
                        <video controls id="player">
                            ...
                            <a href="https://s3.eu-central-1.amazonaws.com/selfgrowthacademy-live/VideosXXX/videoxxx.mp4"
                                download>Download</a>
                        </video>
                </div>
                <div class="thrv_wrapper thrv-button" data-css="tve-u-169a7250c95" data-tcb_hover_state_parent=""
                    data-button-style="elevated" data-button-size="m">
                    <a href="https://gloriousenlargement.com/thank-you-downloadyourbook" class="tcb-button-link">
                        <span class="tcb-button-texts"><span class="tcb-button-text" data-css="tve-u-169acb7465e">GREAT!
                                I WANT THIS!... LETS ACCESS MY PROGRAM &gt;&gt;</span></span>
                    </a>
                </div>
                <div class="thrv_wrapper thrv_text_element" data-css="tve-u-169aa4ece97">
                    <p data-css="tve-u-169aa4f0dd1" style="text-align: center;"><a
                            href="http://gloriousenlargement.com/terms" target="_blank" style="color:black;text-decoration: none">TERMS &amp; CONDITIONS</a> |
                        <a href="http://gloriousenlargement.com/privacy" style="color:black;text-decoration: none" target="_blank">PRIVACY POLICY </a> |
                        <a href="http://gloriousenlargement.com/contact" style="color:black;text-decoration: none" target="_blank">CONTACT</a><br>©
                        COPYRIGHT 2019. GloriousEnlargement.com - ALL RIGHTS RESERVED</p>
                </div>
            </div>
        </div>
    </div>
